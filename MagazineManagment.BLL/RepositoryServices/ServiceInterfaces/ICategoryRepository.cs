...
namespace MagazineManagment.BLL.RepositoryServices.ServiceInterfaces
{
    ...
    {
        Task<ResponseService<CategoryViewModel>> CreateCategoryAsync(CategoryCreateViewModel category);
        ...
        Task<ResponseService<CategoryViewModel>> UpdateCategoryAsync(CategoryUpdateViewModel category);
    }
}